<template>
  <div class="container">
    ...
    <el-card class="introduction-card" shadow="hover">
      <div class="introduction">
        <div class="image-container">
          <img :src="speciesImage" alt="Brassica rapa Image" class="species-image" />
        </div>
        <div class="info-container">
          <h2>Brassica rapa</h2>
          <p>A common leafy vegetable belonging to the cruciferous family. It is especially popular in China and East Asia.</p>
          <p>Cabbage leaves are broad, ranging in color from light green to dark green, with distinct veins and soft texture.</p>
          <p>Cabbage is rich in vitamin C, vitamin K, folate and minerals such as calcium and iron. Adaptable, it can grow in different climates and is grown in many parts of the world.</p>
        </div>
      </div>
    </el-card>
    ...
    <el-card shadow="hover" class="chart-card search-card">
      <SearchGene species="F" @search-complete="handleSearchComplete" />
    </el-card>
...
// 导入图片
import speciesImage from '@/assets/img/home/genefeature/B6.svg';

// 面包屑导航配置
const breadcrumbs = [
  { name: 'Home', path: '/' },
  { name: 'Gene feature', path: '/genefeature' },
  { name: 'Brassica rapa', path: '/genefeature/brassicarapa' }
];

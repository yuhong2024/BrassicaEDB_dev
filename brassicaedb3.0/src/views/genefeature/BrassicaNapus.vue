    ...
    <el-card class="introduction-card" shadow="hover">
      <div class="introduction">
        ...
        <div class="info-container">
          ...
          <p>Oil crops mainly used in the production of edible oil. The plant is 60-120 cm tall, with broad leaves and yellow flowers.</p>
          <p>The fruit is a long pod containing small, hard seeds. Suitable for temperate climates, preferring fertile, well-drained soil.</p>
          <p>The oil of brassica napola is rich in unsaturated fatty acids, which is good for health and is widely used in the food industry.</p>
        </div>
      </div>
    </el-card>

<template>
  <div class="container">
    ...
    <el-card class="introduction-card" shadow="hover">
      <div class="introduction">
        ...
        <div class="info-container">
          <h2>Brassica nigra</h2>
          <p>A plant belonging to the cruciferous family, also known as black mustard. Its seeds are often used to make mustard, a spicy condiment.</p>
          <p>The seeds are black or dark brown, usually small and pungent, and are often used as a flavoring or in traditional medicine.</p>
          <p>Black mustard is also used in a variety of dishes, especially in Asian and European cooking.</p>
        </div>
      </div>
    </el-card>
    ...
    <el-card shadow="hover" class="chart-card search-card">
      <SearchGene species="D" @search-complete="handleSearchComplete" />
    </el-card>

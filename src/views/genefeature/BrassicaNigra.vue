    ...
    <el-card class="introduction-card" shadow="hover">
      <div class="introduction">
        <div class="image-container">
          <img :src="speciesImage" alt="Brassica nigra Image" class="species-image" />
        </div>
        <div class="info-container">
          <p>
            Brassica nigra, commonly known as black mustard, is a flowering plant species
            widely used for oil production. The plant typically grows 60-120 cm tall,
            producing broad leaves and small yellow flowers. Its seeds are used to
            produce mustard oil and have other culinary applications. This species thrives
            in temperate climates and prefers well-drained, fertile soil.
          </p>
        </div>
      </div>
    </el-card>
...
import speciesImage from '@/assets/img/home/genefeature/B4.svg';

// Breadcrumbs Configuration
const breadcrumbs = [
  { name: 'Home', path: '/' },
  { name: 'Gene feature', path: '/genefeature' },
  { name: 'Brassica nigra', path: '/genefeature/brassicanigra' }
];
...
const drawBarChart = () => {
  ...
  horizontalBarChartOptions.value = {
    ...
    grid: {
      left: '15%',  // Reduce left margin to ensure labels fit without too much whitespace
      right: '5%',  // Reduce right margin
      bottom: '10%',
      top: '10%',
      containLabel: true  // Ensure labels are fully contained
    }
  };
};
